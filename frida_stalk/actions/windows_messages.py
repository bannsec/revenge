...
class ActionWindowsMessages:
    ...
    def __init__(self, stalker, include_module=None, windows_message=None, *args, **kwargs):
        """
        Args:
    ...
    def action_windows_messages(self):
        ...
        def windows_cb(message, data):
            ...
            handler_module = self._stalker.get_module_by_addr(handler_ip)
            handler_offset = handler_ip - self._stalker.modules[handler_module]['base']
        ...
        windows_js = self._stalker.load_js('windows_stalk_message_handlers.js')

        script = self._stalker.session.create_script(windows_js)
    ...
    def _action_windows_messages_intercept(self, module, offset):
        ...
        js = self._stalker.load_js('windows_intercept_message_handler.js')
        ...
        script = self._stalker.session.create_script(js, runtime='v8')
